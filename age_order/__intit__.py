...
def years_match_months_match_days_diff():
    ...
    check50.run("./ages").stdin("4").stdin("Simon").stdin("1").stdin("23").stdin("2005").stdin("Lyra").stdin("1").stdin("12").stdin("2005").stdin("Olivia").stdin("1").stdin("19").stdin("2005").stdin("Audrey").stdin("1").stdin("3").stdin("2005").stdout("Audrey\nLyra\nOlivia\nSimon\n", regex=False)
